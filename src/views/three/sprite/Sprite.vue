...
//添加草地模型
 function addGrass(){
  ...
  // 加载草地纹理贴图
  const src = import.meta.env.VITE_IS_GITHUB ?  location.origin + '/' + import.meta.env.VITE_SPLICING + '/img/grasslight-big.jpg':  location.origin + '/img/grasslight-big.jpg'
...
// 添加树
function addTree(){
  const src = import.meta.env.VITE_IS_GITHUB ?  location.origin + '/' + import.meta.env.VITE_SPLICING + '/img/tree-02.png' : location.origin + '/img/tree-02.png'
...
function addRain(){
  const src =  import.meta.env.VITE_IS_GITHUB ?  location.origin + '/' + import.meta.env.VITE_SPLICING +  '/img/sprite.png':location.origin + '/img/sprite.png'
